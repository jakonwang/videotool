...
8. **APP Fallback 302**（2025-11-23 晚）：即使APP退回到 `force_download=1`（也就是旧版代理URL），后端也会根据 User-Agent/`prefer_cdn=1` 自动 302 跳到七牛 CDN，DownloadManager 直接走 CDN，彻底告别慢速流式下载。
